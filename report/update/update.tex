    ...
    \subsection{Physical Theory}
        ...
        \subsubsection{Particle Production} \label{sec:particleProduction}
            ...
            \begin{equation} \label{eq:densityFromPhase}
                \widetilde{n}_\mathbf{k} = - \frac{\hbar}{U} \partial_t \widetilde{\theta}_\mathbf{k}.
            \end{equation}
            ...
            \begin{enumerate}
                \item Solve the field equation (\ref{eq:fieldEquationdeSitter}) for $\widetilde{\theta}_\mathbf{k}(t)$
                \item Differentiate $\widetilde{\theta}_\mathbf{k}(t)$ to get $\widetilde{n}_\mathbf{k}(t)$ as in equation (\ref{eq:densityFromPhase})
