...
\title{\Large \vspace{-0.625in} \emph{Production of Massless, Spin-0 Quasiparticles in Analog (3+1) Inflationary Cosmologies Using High-Performance Finite-Differences} \vspace{-0.15in}}
...
\pagebreak
        ...
        \subsubsection{Phononic \& Free-Particle Modes}
            ...
            For a de Sitter universe, the scaling function is defined such that $a(t) = \exp(-t / t_s)$.  Therefore, field equation for a de Sitter universe is
            ...
            where the scaling function $b$ has been defined such that $a(t) = e^{-t / t_s}$ so that the analog universe is undergoing a de Sitter type expansion on a time scale $t_s$.  The boundary conditions for equation (\ref{eq:fieldEquationdeSitter}) come from the fact that $\widetilde{\theta}_\mathbf{k}$ needs to be continuous at the moment when expansion begins.
        ...
        \subsubsection{Particle Production} \label{sec:particleProduction}
            ...
            \begin{equation}
                u_k(t) = \frac{1}{2 \sqrt{n_0}} n_k(t) + i \sqrt{n_0} \widetilde{\theta}_k(t)
            \end{equation}
            \begin{equation}
                v_k(t) = \frac{1}{2 \sqrt{n_0}} n_k(t) - i \sqrt{n_0} \widetilde{\theta}_k(t),
            \end{equation}
            \end{subequations}
