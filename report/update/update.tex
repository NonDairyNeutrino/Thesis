    ...
    \subsection{Physical Theory}
        ...
        \subsubsection{Setting up the Analog}
            ...
            \begin{equation} \label{eq:Madelung}
                \psi(\mathbf{x}, t) = \sqrt{n_0 + \Delta n(\mathbf{x}, t)} e^{i \left( \theta_0 + \Delta\theta(\mathbf{x}, t) \right)},
            \end{equation}

            where $n_0 + \Delta n(\mathbf{x}, t)$ is the linearized form of the real density field $n(\mathbf{x}, t)$ and $\theta_0 + \Delta\theta(\mathbf{x}, t)$ is the linearized form of the real phase field $n(\mathbf{x}, t)$, equation (\ref{eq:GPE}) becomes\cite{Jain} 
