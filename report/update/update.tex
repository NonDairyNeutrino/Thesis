...
\pagebreak
    ...
    \subsection{Computational Implementation}
        ...
        \subsubsection{The Parareal Algorithm}
            ...
            \begin{itemize}
                \item The base Parareal Algorithm doesn't conserve energy no matter if the coarse and fine propagators are symplectic
            \end{itemize}
            ...
            \begin{algorithm}
                ...
                \KwIn{Coarse Propagator $\mathcal{C}$, Fine Propagator $\mathcal{F}$, Initial Condition $u_0$, Discretized Time Domain $\{T_0, T_1, \ldots, T_N\}$}
                \KwOut{Solution $\{u_0, u_1, \ldots, u_N\}$}
                \tcp*[l]{INITIALIZATION}
                Initialize data with the coarse propagator 
            \end{algorithm}
