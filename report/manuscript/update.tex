...
\title{\Large \vspace{-0.625in} \textit{Scalable Parallel-in-Time Integration for \\ Particle Production in Analog Cosmologies} \vspace{-0.15in}}
...
\pagebreak
    ...
    \subsection{Computational Implementation}
        ...
        \subsubsection{Parallel-in-Time Integration \& The Parareal Algorithm}
        ...
        \subsubsection{Supercomputing with Julia}

            \begin{itemize}
                \item Distributed computing across nodes with \verb|Distributed.jl|
                \item GPU computing with CUDA and multiple cards with \verb|CUDA.jl|
            \end{itemize}
