...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                \item Conserve energy $\implies$ Use symplectic integrator
                \item $a_m, b_m$ define optimality
                \item[]
    ...
    \begin{columns}
        \column{0.5\textwidth}
            \begin{itemize}
                ...
                \item Solve in parallel with multiple GPUs
                \item Use the CWU ``Turing'' supercomputer
                \item 4x4 NVIDA P100 GPUs - Each 10.6 TFLOPS of single-precision (FP32) performance
                \item 180 GBps GPU-GPU bandwidth
                \item 80 GBps GPU-CPU bandwidth
            \end{itemize}
        \column{0.5\textwidth}
            \begin{figure}[h]
                \centering
                \includegraphics[width=0.65\textwidth]{images/NVLink.png}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Need to solve the equation of motion for many different parameters
