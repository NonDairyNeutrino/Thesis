...
\begin{frame}
    ...
    \setstretch{1.25}
    \begin{itemize}
        \item<1-> One equation describes both ultra-cold quantum gases and inflation ($a$) particles
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{itemize}
                \item<1-> Can't traditionally parallelize IVPs
                \item<2-> Make 1 initial coarse solution
                \item<3-> Make many fine solutions in parallel
        ...
        \begin{column}{0.6\textwidth}
            \begin{figure}
                ...
                \caption{Illustration of the first iteration in Parareal (\href{https://commons.wikimedia.org/wiki/File:Parareal.svg}{Source})}
            \end{figure}
        \end{column}
    \end{columns}
...
\begin{frame}
    ...
    \begin{figure}[h]
        \centering
        \movie[autostart,loop,showcontrols]{\includegraphics[height=0.7\textheight]{images/parareal_thumbnail.png}}{images/Parareal_Animation.ogx}
        \caption{The \textit{Parareal} approach to solving initial value problems in parallel.}
    \end{figure}
